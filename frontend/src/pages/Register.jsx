    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-[480px] px-6 mt-20">
        <form
          ...
          {errors.backend && (
            <div
              className="bg-red-50 border-l-4 border-red-500 text-red-700 px-4 py-1 flex items-center rounded mb-6"
              role="alert">
              <div className="flex">
                <div className="py-1">
                  <MdOutlineError className="w-6 h-6 mr-4 text-red-500" />
                </div>
                <span className="flex text-sm items-center">{errors.backend}</span>
              </div>
            </div>
          )}
