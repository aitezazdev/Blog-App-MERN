...
const HomeIntro = ({ searchData }) => {
  ...
  return (
    <section className="min-h-[60vh] flex flex-col justify-center items-center text-center px-4 relative z-10">
      ...
      <div className="flex items-center border border-gray-700 rounded-xl px-4 py-2 w-full max-w-md ring-1 focus-within:ring-emerald-200 transform transition duration-150 ease-in-out">
        <input
          value={data}
        ...
        />
        <FiSearch className="text-white text-xl cursor-pointer" onClick={() => searchData(data)} />
      </div>
    </section>
  );
};
